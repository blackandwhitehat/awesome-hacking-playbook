...
└── MANIFEST.json      # Auto-generated chapter listing for the web reader
```

`MANIFEST.json` is auto-generated by GitHub Actions from the numbered markdown files. Just name your chapters `XX-topic.md` and push. No manual manifest updates needed.
